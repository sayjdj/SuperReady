...
public class CustomerSupportActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.titlebar_custom_support);
        ...
        webView.loadUrl(InfoManager.URL_CUSTOMER_SUPPORT + InfoManager.userToken, header);            // 웹뷰에서 불러올 URL 입력
    ...
    void setView() {
        webView = (WebView) findViewById(R.id.customSupport_webView);
        layout_back = (RelativeLayout) findViewById(R.id.titlebar_customSupport_back);
    }
